  ...
  return (
    <main className="legal-page">
      ...
      <section className="support-grid">
        ...
        <article><Mail /><h2>צריכים עזרה נוספת?</h2><p>שלחו לנו הודעה ל־<a className="support-email" href="mailto:netanelvision@gmail.com">netanelvision@gmail.com</a> ונשמח לעזור.</p></article>
      </section>
