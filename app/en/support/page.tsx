  ...
  return (
    <main className="legal-page" dir="ltr" lang="en">
      ...
      <section className="support-grid">
        ...
        <article><Mail /><h2>Need more help?</h2><p>Email us at <a className="support-email" href="mailto:netanelvision@gmail.com">netanelvision@gmail.com</a> and we will be happy to help.</p></article>
      </section>
